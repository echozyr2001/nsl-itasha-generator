...
def main():
    ...
    if not os.path.exists(args.mask):
        print(f"Warning: Mask file '{args.mask}' not found. Using default or proceeding without mask.")
    ...
    try:
        analysis_result = vision.analyze_image(valid_paths, mask_path=mask_path)
    ...
    base_texture_path = generator.generate_image(analysis_result, valid_paths, args.output, mask_path=mask_path)
